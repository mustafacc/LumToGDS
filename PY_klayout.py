...
def klayout_mergefiles(directory="output",outputname = "lumexport.gds",removetempfiles=True):
    ...
    try:
        ...
        print("[ERROR]: Klayout module not installed. Please refer to the 'Installation Instructions' in the readme.")
        installed = False
...
if __name__ == '__main__':     
    ...
    if klayout_mergefiles():
        ...
        print("[ERROR]: Unexpected error. You may close this CMD window.")
